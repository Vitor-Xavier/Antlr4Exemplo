...
public partial class ExemploBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IExemploVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitStatementBraceBlock([NotNull] ExemploParser.StatementBraceBlockContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitStatementRuleBlock([NotNull] ExemploParser.StatementRuleBlockContext context) { return VisitChildren(context); }
	/// <summary>
